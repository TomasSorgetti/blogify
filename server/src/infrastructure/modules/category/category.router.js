...
import CategoryValidation from "../../http/middlewares/validators/category.validators.js";
...
export default class CategoryRouter {
  ...
  #setupRoutes() {
    ...
    this.#router.get(
      "/:id",
      CategoryValidation.getById().handle,
    ...
    this.#router.post(
      "/",
      this.#authMiddleware,
      CategoryValidation.create().handle,
    ...
    this.#router.patch(
      "/:id",
      this.#authMiddleware,
      CategoryValidation.update().handle,
    ...
    this.#router.delete(
      "/:id",
      this.#authMiddleware,
      CategoryValidation.delete().handle,
